 ...
 */
public class Ende {
    private static String strDefaultKey = "GUOHONGL";
     ...
     * @throws Exception
     */
    public Ende(String strKey) throws Exception {
        Security.addProvider(new com.sun.crypto.provider.SunJCE());
        Key key = new javax.crypto.spec.SecretKeySpec(strKey.getBytes("GBK"), "DES");
